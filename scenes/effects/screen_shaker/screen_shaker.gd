...
func start(duration = 0.2, frequency = 15, max_amplitude = 16, priority = 0):
...
func _new_shake():
	var rand = Vector2(rand_range(-max_amplitude, max_amplitude), rand_range(-max_amplitude, max_amplitude))
